...
for epoch in range(1, EPOCHS + 1):
    ...
    if avg_dice > best_val_dice:
        ...
        torch.save(model.state_dict(), os.path.join(SAVE_DIR, "sinet_gra_best.pth"))
        print(" Saved best model (by Dice):", os.path.join(SAVE_DIR, "sinet_gra_best.pth"))
...
plt.ylabel("Loss")
plt.legend()
plt.title("SINet + GRA Training Curve")
plt.tight_layout()
plt.savefig(os.path.join(SAVE_DIR, "sinet_gra_loss_curve.png"))
