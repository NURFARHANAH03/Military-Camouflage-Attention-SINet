...
if button1:#True condition
    st.write("This is some text.")

st.header("Start of the Checkbox Section")
like = st.checkbox("Do like this app?")
button2 = st.button("Submit")
if button2:
    if like:
        st.write("Thanks. I like it too.")
    else:
        st.write("I'm sorry. You had bad tastes.")

st.header("Start of the Radio Section Button")
animal = st.radio("What animal is your favourite?", ("Lions", "Tigers", "Bears"))
...
animal2 = st.selectbox("What animal is your favourite?", ("Lions", "Tigers", "Bears"))
...
options = st.multiselect("What animal is your favourite?", ("Lions", "Tigers", "Bears"))
button5 = st.button("Print Animals")
if button5:
    st.write(options) #order of data
...
user_text = st.text_input("What's your favourite movie?", "Star Wars Ep.IV")
